...
*/
/*
define('USER_DB_SERVER','198.61.237.254'); // database host to connect
define('USER_DB_SERVER_USERNAME','promout_dev'); // database user login to connect
define('USER_DB_SERVER_PASSWORD','BokchivmueheHy'); // database user password to connect
define('USER_DB_DATABASE','promout_dev');  	  // database name
