<?php
class Paypalauth_Identity_ExpressController extends  Mage_Core_Controller_Front_Action{
	...
	public function startAction()
	{
		...
		$paypalUrl =  Mage::helper('paypalauth_identity')->getPayPalExpressUrl($token);
