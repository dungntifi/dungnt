...
class Paypalauth_Identity_Helper_Data extends Mage_Customer_Helper_Data {
	...
	const RETURN_URL = 'login/openidconnect/return';
	
	const XML_PATH_ENABLED = 'customer/startup/paypalauth_enable';
	
	const XML_PATH_SANDBOX_MODE = 'customer/startup/paypalauth_sandboxenabled';
	
	const XML_PATH_CLIENT_ID = 'customer/startup/paypalauth_clientid';
	
	const XML_PATH_CLIENT_SECRET = 'customer/startup/paypalauth_secret';
	
	const XML_PAYPAL_LIGHTBOX_STATUS = 'payment/paypallightbox/enable';
	
	const XML_PAYPAL_LIGHTBOX_SANDBOX = 'payment/paypallightbox/sandbox';
	...
	public function __construct() {
		...
		$this->_sandbox = Mage::getStoreConfig ( 'customer/startup/paypalauth_sandboxenabled' );
	...
	public function getPopUpLoginUrl() {
		return $this->_getUrl ( 'login/openidconnect/login', array (
				'_secure' => true 
		) );
	}
	...
	public function getAskLinkPostActionUrl() {
		...
		return $this->_getUrl ( 'login/openidconnect/askLinkPost', $params );
	}
	...
	public function isEnable(){
		return Mage::getStoreConfig(self::XML_PAYPAL_LIGHTBOX_STATUS);
	}
}