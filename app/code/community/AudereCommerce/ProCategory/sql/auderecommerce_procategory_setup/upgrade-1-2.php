...
$sql = <<<SQL
ALTER TABLE `$ruleTableName` ADD `filter_new` TINYINT(1) UNSIGNED NOT NULL DEFAULT '0';
ALTER TABLE `$ruleTableName` ADD `filter_sale` TINYINT(1) UNSIGNED NOT NULL DEFAULT '0';
SQL;
