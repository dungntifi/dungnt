    ...
    extends Mage_Eav_Model_Convert_Parser_Abstract
{
    ...
    public function unparse()
    {
       ...
       $recordlimit = $this->getVar('recordlimit');
			 ...
			 $select_qry = "SELECT ".$prefix."eav_attribute.*, ".$prefix."eav_attribute_set.*, ".$prefix."eav_attribute_group .* FROM `".$prefix."eav_attribute` INNER JOIN ".$prefix."eav_entity_attribute ON ".$prefix."eav_entity_attribute.entity_type_id = ".$prefix."eav_attribute.entity_type_id AND ".$prefix."eav_entity_attribute.attribute_id = ".$prefix."eav_attribute.attribute_id INNER JOIN ".$prefix."eav_attribute_set ON ".$prefix."eav_attribute_set.attribute_set_id = ".$prefix."eav_entity_attribute.attribute_set_id INNER JOIN ".$prefix."eav_attribute_group ON ".$prefix."eav_attribute_group.attribute_group_id = ".$prefix."eav_entity_attribute.attribute_group_id WHERE ".$prefix."eav_attribute.entity_type_id = '".$EntityTypeId."' LIMIT ".$recordlimit."";
					...
					foreach($rows as $data)
					 { 
						 ...
						 $select_attribute_options_qry = "SELECT ".$prefix."eav_attribute.*, ".$prefix."eav_attribute_option_value.* FROM `".$prefix."eav_attribute` INNER JOIN ".$prefix."eav_attribute_option ON ".$prefix."eav_attribute_option.attribute_id = ".$prefix."eav_attribute.attribute_id INNER JOIN ".$prefix."eav_attribute_option_value ON ".$prefix."eav_attribute_option_value.option_id = ".$prefix."eav_attribute_option.option_id WHERE ".$prefix."eav_attribute.attribute_id = '".$data['attribute_id']."'";
							...
							// AND ".$prefix."eav_attribute_option_value.store_id = '".$storeID."'
