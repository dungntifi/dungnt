...
class Mage_CatalogInventory_Model_Stock_Item extends Mage_Core_Model_Abstract
{
    ...
    public function checkQty($qty)
    {
        ...
        $this->setQty(Mage::helper('cutomstockstatus')->getTotalQtyOfItem(Mage::getModel('catalog/product')->load($this->getProductId())));
    ...
    public function checkQuoteItemQty($qty, $summaryQty, $origQty = 0)
    {
        ...
        if($helper->getTotalQtyOfItem(Mage::getModel('catalog/product')->load($this->getProductId())) <= 0){
