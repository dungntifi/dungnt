...
class Amasty_Ogrid_Block_Adminhtml_Settings_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    public function __construct()
    {
        ...
        $this->setTitle(Mage::helper('amogrid')->__('Attributes Configuration'));
    }
    
    protected function _beforeToHtml()
    {
        $this->addTab('attributes_section', array(
            'label'     => Mage::helper('amogrid')->__('Attributes Configuration'),
            'title'     => Mage::helper('amogrid')->__('Attributes Configuration'),
